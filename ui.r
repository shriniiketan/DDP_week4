...
shinyUI(
    navbarPage("Application",
               tabPanel("Analysis",
                        fluidPage(
                            titlePanel("Relationship between different variables and miles per gallon (MPG)"),
                            sidebarLayout(
                                sidebarPanel(
               ...
               tabPanel("Go back to my Github repository",
                        a("https://github.com/harneet2512/DDP_Week_4"),
                        hr(),
                        h4("This is my first shiny app."),
                        h4("Github Repositry Name:DDP_Week_4")
               )
    )
)
